...
enum en_MONITOR_PACKET_TYPE
{
	...
	en_PACKET_CS_SECTOR_TOOL_REQ_LOGIN,

	en_PACKET_CS_SECTOR_TOOL_RES_LOGIN,

	en_PACKET_CS_SECTOR_TOOL_DATA_UPDATE,
...
enum en_PACKET_SS_MONITOR_DATA_UPDATE_ENUM
{
